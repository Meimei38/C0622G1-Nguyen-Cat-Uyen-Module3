...
<center>
    ...
    <form action="/users?action=search" method="post" >
        <table>
            ...
            <tr>
                <td><input type="radio" name="option" value="country" onclick="openInput(this.value)">Country:
                </td>
                <td><input type="text" name="country" id="country" disabled="disabled"></br>
                </td>
            </tr>
            <tr>
                <td> </td>
