...
update product_view 
set product_status = 'chưa có hàng' where (product_status = 'còn hàng');
...
Create Procedure add_record(in product_code int, product_name varchar(50), product_price double, product_amount int, product_description text, product_status varchar(20))
    BEGIN
	INSERT INTO `demo`.`products` (`product_code`, `product_name`, `product_price`, `product_amount`, `product_description`,`product_status`) VALUES (product_code,product_name,product_price,product_amount,product_description,product_status);
    END//
DELIMITER ;
